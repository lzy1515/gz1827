<template>
  <div class="book">
    ...
    <div class="lis">
      <div class="item" v-for="(hot,index) in Publish1" :key="index" v-if="index == 0" @click="go(hot)">
      ...
      <ul>
        <li v-for="(hot,index) in Publish1" :key="index" v-if="index*1!=0" @click="go(hot)">
    ...
    <div class="lis">
      <div class="item" v-for="(hot,index) in Publish2" :key="index" v-if="index == 0" @click="go(hot)">
        <div class="horizontal"><img v-if="hot" :src="hot.cover"></div>
        <div class="text">
          <span v-if="hot">{{hot.title}}</span>
          <div class="desc">
      ...
      <ul>
        <li v-for="(hot,index) in Publish2" :key="index" v-if="index*1!=0" @click="go(hot)">
          <p><span>[{{hot.catName}}]</span>&nbsp;{{hot.title}}<b>{{hot.author}}著</b></p>
          <p>{{hot.lpushname}}</p>
        </li>
      </ul>
